const purchase = (data) => {
    ...
    const getItems = () => {
        ...
        template += `
            <div style="font-family: Helvetica, Arial, sans-serif; letter-spacing: 0.5px; line-height: 1.4; margin: 0; padding: 15px 25px ; text-transform: uppercase; text-align: right;">
                <h3>
                    Total: ${total} €
                </h3>
            </div>
